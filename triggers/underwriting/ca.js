...
const payload = {
  ...
  "$.documents.bkr_house_rent_ownership.document_id": "9888d558-8480-4dbe-95fd-07e2dadbede3",
  // "$.documents.bkr_house_rent_ownership.document_type": "HOUSERENTOWNERSHIP",
  "$.documents.asset_payment_receipt.document_id": "9888d558-8480-4dbe-95fd-07e2dadbede3",
  // "$.documents.asset_payment_receipt.document_type": "ASSETPAYMENTRECEIPT",
  "$.documents.asset_payment_invoice.document_id": "9888d558-8480-4dbe-95fd-07e2dadbede3",
  // "$.documents.asset_payment_invoice.document_type": "ASSETPAYMENTINVOICE",
  "$.documents.asset_payment_agreement.document_id": "9888d558-8480-4dbe-95fd-07e2dadbede3",
  // "$.documents.asset_payment_agreement.document_type": "ASSETPAYMENTAGREEMENT",
  "$.documents.release_letter.document_id": "9888d558-8480-4dbe-95fd-07e2dadbede3",
  // "$.documents.release_letter.document_type": "WAIVERLETTER",
  "$.documents.asset.in_front_of_bfi_office.document_id": "9888d558-8480-4dbe-95fd-07e2dadbede3",
  // "$.documents.asset.in_front_of_bfi_office.document_type": "INFRONTOFBFIOFFICE",
  "$.documents.asset_dump_truck_on_lift_position.document_id": "9888d558-8480-4dbe-95fd-07e2dadbede3",
  // "$.documents.asset_dump_truck_on_lift_position.document_type": "ASSETDUMPTRUCTONLIFTPOSITION",
  "$.documents.asset_photo_bpkb_productive.document_id": "9888d558-8480-4dbe-95fd-07e2dadbede3",
  // "$.documents.asset_photo_bpkb_productive.document_type": "ASSETPHOTOBPKBPRODUCTIVE",
  "$.documents.business_legality.document_id": "9888d558-8480-4dbe-95fd-07e2dadbede3",
  // "$.documents.business_legality.document_type": "BUSINESSLEGALITYDOCUMENT",
  "$.documents.proof_photo_consumer_still_working.document_id": "9888d558-8480-4dbe-95fd-07e2dadbede3",
  // "$.documents.proof_photo_consumer_still_working.document_type": "PROOFPHOTOCONSUMERSTILLWORKING",
  "$.documents.active_spk.document_id": "9888d558-8480-4dbe-95fd-07e2dadbede3",
  // "$.documents.active_spk.document_type": "ACTIVESPK",
  "$.documents.proof_of_payment_for_other_contracts_that_are_still_in_arrears.document_id": "9888d558-8480-4dbe-95fd-07e2dadbede3",
  // "$.documents.proof_of_payment_for_other_contracts_that_are_still_in_arrears.document_type": "PROOFOFPAYMENTFOROTHERCONTRACTSTHATARESTILLINARREARS",
  "$.documents.signing_by_waarmerking_or_legalization.document_id": "9888d558-8480-4dbe-95fd-07e2dadbede3",
  // "$.documents.signing_by_waarmerking_or_legalization.document_type": "SIGNINGBYWAARMERKINGORLEGALIZATION",
  "$.documents.cross_collateral_and_default_all_active_contracts.document_id": "9888d558-8480-4dbe-95fd-07e2dadbede3",
  // "$.documents.cross_collateral_and_default_all_active_contracts.document_type": "CROSSCOLLATERALANDDEFAULTALLACTIVECONTRACTS",
