...
import { generateNdf2wPayload } from "./payloads/ndf2w";
...
export const Ndf2wRO = async (actor) => {
  ...
  try {
    ...
    payload = {
      ...payload,
      "$.channel.signing_processor": "digital",
      "$.customer.consent.auto_signing": "2026-01-06T08:04:27.216665182Z",
      "$.documents.draft_agreement.document_id": "6c9f236f-6115-4d73-8abc-ec1873a9bf99",
      "$.previous_agreement.number": "4012606935",
    }
