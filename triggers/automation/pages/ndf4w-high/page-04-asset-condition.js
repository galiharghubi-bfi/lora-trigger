...
export const Page4AssetCondition = (taskId, params = {}) => ({
  ...
  payload: {
    ...
    "$.customer.personal.funds_other_than_purchase": "true",
    "$.customer.personal.installment_helper_than_spouse": "true",
    ...
    "$.customer.professional.proof_monthly_income": "21000000",
    "$.customer.professional.proof_variable_income": "1000000",
    "$.customer.professional.other_business": "Ada",
    "$.customer.professional.business_suitability": "true",
    "$.customer.professional.employment_status": "PERMANENT_EMPLOYEE",
    "$.customer.professional.business_since_year": "2013",
